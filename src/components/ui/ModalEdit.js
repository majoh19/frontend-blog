...
export default function ModalEdit({
    title, closeModal, handleChange, category, loadingSave, editCategory
}) {
    return (
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        {loadingSave ? (
                            ...
                            <button type="button" className="btn btn-primary" onClick={editCategory} disabled={category?.name?.length === 0}>Save</button>
                        )}
                    </div>
                </div>
            </div>
